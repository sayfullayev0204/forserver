...
#         'NAME': 'host5402_alibek',          # PostgreSQL'da yaratgan bazangiz nomi
#         'USER': 'host5402_ali',        # Foydalanuvchi nomi
#         'PASSWORD': 'sayfullayev',     # Foydalanuvchi paroli
#         'HOST': 'localhost',             # Server joylashuvi
